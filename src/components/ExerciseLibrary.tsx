  ...
  return (
    <section className="py-12 px-4 max-w-6xl mx-auto pb-40">
      <div className="flex flex-col md:flex-row justify-between items-end mb-10 gap-4">
        <div>
          <h2 className="text-3xl font-bold mb-2">Mashqlar Kutubxonasi</h2>
          <p className="text-muted-foreground">Nutqni rivojlantirish uchun maxsus ishlab chiqilgan interaktiv mashqlar.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {filteredExercises.map((ex) => (
          <Card key={ex.id} className="group hover:shadow-2xl transition-all duration-300 border-2 hover:border-primary/50 flex flex-col">
            <CardHeader className="pb-2">
              ...
              <Badge className="w-fit mb-2">{ex.category}</Badge>
